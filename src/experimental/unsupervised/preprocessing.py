...
def get_github_data():
    ...
    df_github.to_csv(path_or_buf='../../../data/unsupervised/full_github_issues.csv')
...
if __name__ == "__main__":
    ...
    df_github_own = pd.read_csv('../../../data/unsupervised/full_github_issues.csv')
    df_monkey_own = pd.read_csv('../../../data/unsupervised/full_monkey.csv')
